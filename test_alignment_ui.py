...
def test_alignment_ui():
    ...
    assert hasattr(viewer.gl_widget, 'align_faces'), "GL widget should have align_faces attribute"
    assert viewer.gl_widget.align_faces == False, "Alignment should be disabled by default"
    ...
    assert viewer.gl_widget.align_faces == False, "GL widget align_faces should be False"
