...
def test_frame_navigation(viewer):
    ...
    assert viewer.current_frame == n_frames - 1, f"Current frame should be {n_frames - 1}"
...
def test_data_access():
    ...
    assert base_landmarks.shape == (n_landmarks, 3), "Base landmarks shape should be (n_landmarks, 3)"
