...
def test_layout_stretch_factors():
    ...
    ), "Main layout should be a QVBoxLayout"
    ...
    assert (
        info_stretch == 0
    ), f"info_label should have stretch 0, got {info_stretch}"

    print("  ✓ All stretch factors are correct!")
    print(
        "  ✓ gl_widget will occupy maximum available vertical space (stretch=1)"
    )
    print(
